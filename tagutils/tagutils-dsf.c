...
#define GET_DSF_INT64(p)                                                                                                                                      \
    ((((uint64_t)((p)[7])) << 56) | (((uint64_t)((p)[6])) << 48) | (((uint64_t)((p)[5])) << 40) | (((uint64_t)((p)[4])) << 32) | (((uint64_t)((p)[3])) << 24) \
     | (((uint64_t)((p)[2])) << 16) | (((uint64_t)((p)[1])) << 8) | (((uint64_t)((p)[0]))))

#define GET_DSF_INT32(p) ((((uint8_t)((p)[3])) << 24) | (((uint8_t)((p)[2])) << 16) | (((uint8_t)((p)[1])) << 8) | (((uint8_t)((p)[0]))))
